...
#define ISP_PARAM_OFFSET_SIZE   (0x68)
...
/* Black level preset data */
static short const ISP_Preset_BL = ISP_LIMIT_BL_DEFAULT;
...
static unsigned char all_v10_tbl_data[ISP_SET_ALLDATA_SIZE_V10] =
{
   ...
   0x08, 0x00, 0x10, 0x00, 0x00, 0x02, 0x08, 0x00, 0x10, 0x00, 0x00, 0x02, 0x40, 0x20, 0x80, 0x80,              /* [0092 - 00A1] (bit07) 3DNR                   */
...
static unsigned char all_v11_tbl_data[ISP_SET_ALLDATA_SIZE_V11] =
{
    ...
    0xFF, 0x8F,                                                                                                     /* [0002 - 0003] renew data (bit sum)               */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                         /* [0004 - 000F] reserved area                      */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                                                 /* [0010 - 0017] reserved area                      */
    ...
    0x00,                                                                                                           /* [00AA       ] (bit10) Unsharp mask strength      */
    0x1C,                                                                                                           /* [00AB       ] (bit10) Unsharp mask coring        */
    0x01,                                                                                                           /* [00AC       ] (bit11) AE ON/OFF                  */
    0x6A,                                                                                                           /* [00AD       ] (bit11) AE target brightness level */
    0x64, 0x00,                                                                                                     /* [00AE - 00AF] (bit11) AE default expose level    */
    0x0A,                                                                                                           /* [00B0       ] (bit11) AE threshold               */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,     /* [00B1 - 00FE] reserved area                      */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00,                                                                                                           /* [00FF       ] (bit15) gamma ON/OFF                 */
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,                 /* [0100 - 01FF] (bit11) gamma table                  */
    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F,
    0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F,
    0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F,
    0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4A, 0x4B, 0x4C, 0x4D, 0x4E, 0x4F,
...
/* Create AE table */
static set_ae_table( int frame_interval )
{
    int expose_cnt;
    int limit_time = 1;
    int extra_gain = 0;
             ...
             unsigned short out_format, unsigned char *cam_param_p)
{
    ...
    *(short*)(&isp_param[0x5A])   = -ISP_Preset_BL;                                 // Black level
    *(short*)(&isp_param[0x5C])   = -ISP_Preset_BL;
    *(short*)(&isp_param[0x5E])   = -ISP_Preset_BL;
    ...
    *(unsigned char*)(&isp_param[0x67])   = 0;                                      // Padding
    pmem_write( isp_work_adr + ISP_WORK_OFFSET_PARAM, &isp_param[0], 0x68);
#if ISP_DEBUG
    printk( "[ISP DEFAULT PARAM]\n");
    pmem_print( isp_work_adr + ISP_WORK_OFFSET_PARAM, 0x68);
#endif
