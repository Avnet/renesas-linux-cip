				 ...
				 struct v4l2_subdev_mbus_code_enum *code)
{
    ...
    code->code = MEDIA_BUS_FMT_SRGGB8_1X8;   // [ISP Support PKG] YUV -> RAW
...
{
    if (fse->code != MEDIA_BUS_FMT_SRGGB8_1X8)   // [ISP Support PKG] YUV -> RAW
		return -EINVAL;
			     ...
			     struct v4l2_subdev_format *format)
{
    ...
    __format->code = MEDIA_BUS_FMT_SRGGB8_1X8;   // [ISP Support PKG] YUV -> RAW
