...
#define AWB_MODE_OFF        (0)
#define AWB_MODE_ON         (1)

#define AWB_MANUAL          (0)
#define AWB_AUTO            (1)

#define AWB_COLOR_R         (0)
#define AWB_COLOR_G         (1)
#define AWB_COLOR_B         (2)
#define AWB_COLOR_NUM       (3)
...
/* AWB param */
#define ISP_PARAM_AWB_SHIFT         (16)
#define ISP_PARAM_AWB_GAINDIV       (8)


#define ISP_PARAM_AWB_THRESH_WHITE  (64)
#define ISP_PARAM_AWB_THRESH_SAT    (384)
#define ISP_PARAM_AWB_THRESH_RGBL   (96)
#define ISP_PARAM_AWB_THRESH_RGBH   (192)
#define ISP_PARAM_AWB_WHITE_CLIP    (32767)
#define ISP_PARAM_AWB_DEFAULT       (0x0100)

#define ISP_PARAM_AWB_PREVENT_BLACK_TH      (4)
#define ISP_PARAM_AWB_RATIO_B_LIMIT_H       (16 << ISP_PARAM_AWB_SHIFT) //16
#define ISP_PARAM_AWB_RATIO_B_LIMIT_L       (4096)                      //0.0625
#define ISP_PARAM_AWB_RATIO_R_LIMIT_H       (16 << ISP_PARAM_AWB_SHIFT) //16
#define ISP_PARAM_AWB_RATIO_R_LIMIT_L       (4096)                      //0.0625
#define ISP_PARAM_AWB_RELIABILITY_TH        (12500)
#define ISP_PARAM_AWB_VARIABLE_SPEED_COEF_1 (2185)                      //0.033
#define ISP_PARAM_AWB_VARIABLE_SPEED_COEF_2 (6554)                      //0.1
#define ISP_PARAM_AWB_VARIABLE_SPEED_COEF_3 (10923)                     //0.167
#define ISP_PARAM_AWB_VARIABLE_SPEED_TH_1H  (66847)                     //1.02
#define ISP_PARAM_AWB_VARIABLE_SPEED_TH_2H  (2 << ISP_PARAM_AWB_SHIFT)  //2
#define ISP_PARAM_AWB_VARIABLE_SPEED_TH_3H  (4 << ISP_PARAM_AWB_SHIFT)  //4
#define ISP_PARAM_AWB_VARIABLE_SPEED_TH_1L  (64225)                     //0.98
#define ISP_PARAM_AWB_VARIABLE_SPEED_TH_2L  (32768)                     //0.5
#define ISP_PARAM_AWB_VARIABLE_SPEED_TH_3L  (16384)                     //0.25
#define ISP_PARAM_AWB_WB_GAIN_G             (1 << ISP_PARAM_AWB_SHIFT)  //1

#define ISP_LIMIT_AWB_GAIN_MAX              (65535)
#define ISP_LIMIT_AWB_GAIN_MIN              (0)
